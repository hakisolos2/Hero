...
if ( fs.existsSync(__dirname + 'auth_info_baileys/creds.json')){ await fs.unlinkSync(__dirname + 'auth_info_baileys/creds.json')}
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
await fs.writeFileSync(__dirname + "/auth_info_baileys/creds.json", cc)
};
